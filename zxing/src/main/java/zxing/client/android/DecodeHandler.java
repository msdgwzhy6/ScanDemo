...
import zxing.client.android.camera.CameraConfigurationManager;
...
final class DecodeHandler extends Handler {
    ...
    DecodeHandler(CaptureActivityHandler captureActivityHandler,CameraManager cameraManager, Map<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        Handler handler = captureActivityHandler;
        if (rawResult != null) {
