...
import zxing.client.android.Config;
import zxing.client.android.camera.open.CameraFacing;
...
public final class CameraConfigurationManager {
    ...
    private int cwNeededRotation;//no use
     ...
     */
    void initFromCameraParameters(OpenCamera camera,Point screenResolution) {
        ...
        //screenResolution are not screen size ,should be surfaceview size
...
//        display.getSize(theScreenResolution);
    ...
    private void initializeTorch(Camera.Parameters parameters,boolean safeMode) {
        boolean currentSetting = Config.KEY_FRONT_LIGHT_MODE == FrontLightMode.ON;
